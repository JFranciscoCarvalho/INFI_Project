...
<h2 style="text-align:center;color:#b53f42;">Docks</h2>

   <table class ="center">

      <thead>
         <th>Dock</th>
         <th>Total Unloaded Pieces</th>
		 <th>P1</th>
		 <th>P2</th>
		 <th>P3</th>
		 <th>P4</th>
        ...
        if(pg_num_rows($result) > 0)
        {
            while($row = pg_fetch_assoc($result))
            {
					...
					<tr>	
                        ...
                        <td><?php echo $row['total_unloaded_pieces']?></td>
